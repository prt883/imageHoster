...
public class UserController {
    ...
    public String registerUser(User user,RedirectAttributes redir) {
        String password= "((?=.*\\d)(?=.*[a-zA-Z])(?=.*[@#$%!*.&]).{0,})";  //Password validation i.e it contain atleast 1 alphabet, 1 number & 1 special character
        ...
        if(matcher.matches()) {
            ...
            redir.addFlashAttribute("passwordTypeError",passwordTypeError);
